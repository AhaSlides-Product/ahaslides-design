...
export class AhaColorPicker extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML =
      `<style>${STYLE}</style><button class="trigger" type="button" part="trigger" aria-haspopup="true"><span class="current" part="current"></span><span class="label">${this.value}</span></button><div class="panel" part="panel" role="listbox">${cells}</div>`;
