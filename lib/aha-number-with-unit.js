...
const STYLE = `
  :host{ display:inline-flex; flex-direction:column; gap:4px; font-family:var(--aha-font-product,"Plus Jakarta Sans",sans-serif) }
  .wrap{ box-sizing:border-box; position:relative; width:max-content; display:inline-flex; align-items:center; gap:0;
  ...
  /* the digit input — a fixed-width compact chip (4ch, tabular figures), never flex-grow */
  .field{ box-sizing:content-box; flex:0 0 auto; width:4ch; min-width:0; height:100%; padding:0; margin:0;
    font-family:inherit; font-size:15px; line-height:21px; font-variant-numeric:tabular-nums;
  ...
  /* stepper sits LEFT of the unit → gap field→stepper 6px (wrap), stepper→unit 4px */
  .unit{ flex:0 0 auto; margin-left:4px; font-family:inherit;
  ...
  .stepper{ flex:0 0 auto; margin-left:6px; display:inline-flex; flex-direction:column; gap:0; opacity:0;
  ...
  .msg{ font-family:inherit; font-size:12px; line-height:18px;
