...
const STYLE = `
  :host{ display:inline-flex; flex-direction:column; gap:4px; width:140px; font-family:var(--aha-font-product,"Plus Jakarta Sans",sans-serif) }
  ...
  .unit{ flex:0 0 auto; font-family:inherit;
