...
export const tokens = {
  ...
  "color": {
    ...
    "button": {
      ...
      "$note": "encourage greens are in export semantic.css but on NO primitive scale — kept per Brian; flag for the DS owner to add green primitives or drop the variant."
    },
    "primitives": {
      "white": "#FFFFFF",
      "black": "#000000",
