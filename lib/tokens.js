...
export const tokens = {
  ...
  "color": {
    ...
    "borderActive": "#A96FF0",
    "borderError": "#F5222D",
    "borderSuccess": "#16C49A",
    "borderWarning": "#FF7747",
    "borderInfo": "#BFD2FF",
    "checkboxBorder": "#D4D4D4",
    "focus": "#D3B4FF",
    "focusRingSoft": "rgba(211,180,255,.3)",
    "bgBase": "#FFFFFF",
    "bgContainer": "#FFFFFF",
    ...
    "bgLayout": "#F7F7F7",
    "bgAccent": "#F9F5FF",
    "bgInformative": "#F4F8FF",
    "bgHover": "#F7F7F7",
    "bgPositive": "#D8FAEF",
    "bgNegative": "#FFF1F0",
    "bgWarning": "#FFF5F0",
    "bgWarningSubtle": "#FFE5D6",
    "bgOverlay": "rgba(26,26,46,.7)",
    "bgDark": "#1A1A2E",
    "bgDarkRaised": "#242442",
    "iconDefault": "#4A4A4A",
    "iconStrong": "#1A1A1A",
    ...
    "button": {
      ...
      "primaryBg": "#6A1EBB",
      "primaryBgHover": "#8644D4",
      "primaryBgPress": "#5715A0",
      "primaryFg": "#FDFDFD",
      "secondaryBg": "#FFFFFF",
      "secondaryBgHover": "#F9F5FF",
      "secondaryBorder": "#E3E3E3",
      "secondaryBorderHover": "#A96FF0",
      "secondaryBorderPress": "#D4D4D4",
      "tertiaryBgHover": "#F9F5FF",
      "tertiaryBgActive": "#F0E4FF",
      "disabledBg": "#E3E3E3",
      "disabledFg": "#B5B5B5",
      "dangerBg": "#F5222D",
      "dangerBgHover": "#FF4D4F",
      "dangerBgPress": "#CF1322",
      "dangerRing": "rgba(255,40,80,.2)",
      "positiveBg": "#4EF1C5",
      "positiveBgHover": "#93F5DA",
      "positiveBgPress": "#20E8B5",
      "positiveFg": "#1A1A1A",
      "focusRing": "rgba(211,180,255,.3)",
      "focusRingSuccess": "rgba(32,232,181,.3)",
      "elevatePrimary": "0 2px 0 0 rgba(0,0,0,.04)",
      "elevateSecondary": "0 2px 0 0 rgba(0,0,0,.016)",
      "encourageBg": "#2CB268",
      "encourageBgHover": "#168C4D",
      "encourageBgPress": "#12733F",
      "$note": "DS V3: primary hover #8644D4 (purple-50, NOT the export's #621BAF), fg #FDFDFD, secondary/tertiary hover brand-tint #F9F5FF + #A96FF0 border, danger active #CF1322, positive teal-40 #4EF1C5 w/ dark label, per-tone soft box-shadow focus ring (spread 2). encourage greens retained but off-palette."
    },
    "primitives": {
      "white": "#FFFFFF",
      "black": "#000000",
    ...
    "alpha": {
      "inkA10": "rgba(26,26,46,.1)",
      "inkA30": "rgba(26,26,46,.3)",
      "inkA50": "rgba(26,26,46,.5)",
      "inkA70": "rgba(26,26,46,.7)",
      "inkA90": "rgba(26,26,46,.9)",
  ...
  "weight": {
    "regular": 400,
    "semibold": 600,
    "$note": "400/600 ONLY (design-owner decision 2026-09-14: 700 dropped from the product type scale — Display uses 600, not Bold). Export's unused 500 also removed. The sole remaining literal font-weight:700 is the MEASURED aha-tabs primary-tab active label (lib/aha-tabs.js:56) — a component-standard exception pending re-measure, not part of the scale."
  },
  "size": {
    "sm": 12,
    "default": 14,
