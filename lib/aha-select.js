 ...
 *
 * DS V3 select chrome: three sizes (small 32 · default 40 · large 48), radius 8, 1px #D3D7E1 input
 * border (--aha-border-input), a brand #6A1EBB hover/focus border + solid #D3B4FF ring, #999999
 * placeholder (--aha-text-placeholder), error/warning status border, and a trailing
...
const STYLE = `
  ...
  :host([size="sm"]) .wrap, :host([size="small"]) .wrap{ height:32px }
  ...
  :host([_placeholder]) .field{ color:var(--aha-text-placeholder,#999999) }
