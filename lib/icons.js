...
function draw(el) {
  ...
  if (!ic) {
    ...
    span.setAttribute('style', `display:inline-block;box-sizing:border-box;width:${size}px;height:${size}px;border:1px dashed var(--aha-color-error,#F5222D);border-radius:4px`);
