 ...
 * The bubble WRAPS within its 240px max-width — a full-sentence `?` help hint lays out as a compact
...
const STYLE = `
  ...
  .bubble{ position:absolute; box-sizing:border-box; max-width:240px; padding:6px 10px;
