...
const STYLE = `
  ...
  .chip{ box-sizing:border-box; display:inline-flex; align-items:center; gap:6px; height:22px; padding:0 8px;
    ...
    border-radius:var(--aha-radius-xs,4px);
...
`;
const CLOSE = '<svg viewBox="0 0 12 12" width="10" height="10" fill="none"><path d="M3 3l6 6M9 3l-6 6" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>'; // ds-lint-allow: svg (10px ✕ close-affordance chrome baked into the tag control, not a catalogue icon)
