...
const STYLE = `
  ...
  :host([variant="plain"]) .item{ padding:0; background:transparent; border-radius:0 }
  .head{ display:flex; align-items:center; gap:8px; min-height:24px; margin-bottom:8px }
  :host([_collapsed]) .head{ margin-bottom:0 }
  .chip{ flex:0 0 auto; display:inline-flex; align-items:center; justify-content:center;
    ...
    background:var(--aha-gray-40,#E3E3E3); color:var(--aha-text-secondary,#4A4A4A);
  ...
  .delete{ flex:0 0 auto; display:inline-flex; align-items:center; justify-content:center; width:24px; height:24px;
    ...
    transition:opacity var(--aha-motion-fast,.1s) var(--aha-ease-out,cubic-bezier(0.215,0.61,0.355,1)),
      ...
      background var(--aha-motion-fast,.1s) var(--aha-ease-out,cubic-bezier(0.215,0.61,0.355,1)) }
  .item:hover .delete, .item:focus-within .delete, .delete:focus-visible{ opacity:1 }
  ...
  .body{ margin-top:0 }
  :host([variant="plain"]) .head{ margin-bottom:4px }
  :host([variant="plain"]) .body{ margin-top:0 }
