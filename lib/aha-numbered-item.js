...
const STYLE = `
  ...
  .item{ box-sizing:border-box; padding:12px; border-radius:var(--aha-radius-default,8px);
...
export class AhaNumberedItem extends HTMLElement {
  static get observedAttributes() { return ['variant', 'n', 'label', 'deletable', 'candelete']; }
  ...
  _sync() {
    ...
    this.shadowRoot.querySelector('.body').hidden = false;
  }
}
