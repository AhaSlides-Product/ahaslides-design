...
const STYLE = `
  ...
  :host([size="2xl"]) button{ height:60px; padding:0 24px; border-radius:var(--aha-radius-xl,16px); font-size:16px }
  ...
  :host([icon-only][size="2xl"]) button{ width:60px }
  ...
  :host([variant=danger]) button{ background:var(--aha-btn-danger-bg,#F5222D); border-color:var(--aha-btn-danger-bg,#F5222D); color:var(--aha-text-inverse,#fff) }
  ...
  :host([variant=positive]) button, :host([variant=success]) button{ background:var(--aha-btn-positive-bg,#4EF1C5); border-color:var(--aha-btn-positive-bg,#4EF1C5); color:var(--aha-btn-positive-fg,#1A1A1A) }
  :host([variant=positive]) button:hover, :host([variant=success]) button:hover{ background:var(--aha-btn-positive-bg-hover,#93F5DA); border-color:var(--aha-btn-positive-bg-hover,#93F5DA) }
  :host([variant=positive]) button:active, :host([variant=success]) button:active{ background:var(--aha-btn-positive-bg-press,#20E8B5); border-color:var(--aha-btn-positive-bg-press,#20E8B5) }
  :host([variant=positive]) button:focus-visible, :host([variant=success]) button:focus-visible{ box-shadow:0 0 0 2px var(--aha-btn-focus-ring-success,rgba(32,232,181,.3)) }
  ...
  :host([variant=primary-alt]) button{ background:var(--aha-btn-primary-bg,#6A1EBB); border-color:var(--aha-btn-primary-bg,#6A1EBB); color:var(--aha-btn-primary-fg,#FDFDFD) }
  :host([variant=primary-alt]) button:hover{ background:var(--aha-btn-primary-bg-hover,#8644D4); border-color:var(--aha-btn-primary-bg-hover,#8644D4) }
  :host([variant=primary-alt]) button:active{ background:var(--aha-btn-primary-bg-press,#5715A0); border-color:var(--aha-btn-primary-bg-press,#5715A0) }
  :host([variant=text]) button{ background:var(--aha-btn-secondary-bg,#fff); border-color:transparent; color:var(--aha-text-secondary,#4A4A4A); font-weight:400 }
  ...
  :host([variant=text-link]) button{ background:var(--aha-btn-secondary-bg,#fff); border-color:transparent; color:var(--aha-text-link,#6A1EBB); font-weight:400 }
