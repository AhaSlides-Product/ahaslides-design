...
const STYLE = `
  ...
  button{
    ...
    cursor:pointer; white-space:nowrap; user-select:none; transition:background var(--aha-motion-fast,.15s) var(--aha-ease,ease), border-color var(--aha-motion-fast,.15s) var(--aha-ease,ease), box-shadow var(--aha-motion-fast,.15s) var(--aha-ease,ease) }
