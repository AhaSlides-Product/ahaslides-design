...
const STYLE = `
  ...
  .track{ position:relative; box-sizing:border-box; width:40px; height:22px; flex:0 0 auto;
    ...
    transition:background var(--aha-motion-fast,.15s) var(--aha-ease,ease), outline-color var(--aha-motion-fast,.15s) var(--aha-ease,ease) }
  .knob{ position:absolute; top:2px; left:2px; width:18px; height:18px; border-radius:50%;
    background:var(--aha-white,#FFFFFF); box-shadow:0 1px 2px rgba(0,0,0,.15); transition:transform var(--aha-motion-fast,.15s) var(--aha-ease,ease) }
