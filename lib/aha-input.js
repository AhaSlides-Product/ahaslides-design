...
const STYLE = `
  ...
  .field{ box-sizing:border-box; width:100%; height:36px; padding:0 12px;
    ...
    outline:none; transition:background var(--aha-motion-fast,.15s) var(--aha-ease,ease), border-color var(--aha-motion-fast,.15s) var(--aha-ease,ease), box-shadow var(--aha-motion-fast,.15s) var(--aha-ease,ease) }
...
export class AhaInput extends HTMLElement {
  static get observedAttributes() { return ['value', 'placeholder', 'type', 'disabled', 'invalid']; }
