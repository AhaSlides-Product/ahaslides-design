/**
 * @ahaslides/design/aha-checkbox — the shared Checkbox primitive.
 *
 *   import '@ahaslides/design/aha-checkbox';   // registers <aha-checkbox>
...
`;
const TICK = '<svg viewBox="0 0 12 12" fill="none"><path d="M2.5 6.3 4.7 8.5 9.5 3.7" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>';
