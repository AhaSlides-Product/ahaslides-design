...
const STYLE = `
  ...
  /* correct → the WHOLE card paints success-green (green border over a faint success tint) */
  ...
  :host([correct]) .row:focus-within{ border-color:var(--aha-border-success,#16C49A);
