 ...
 * `thanks` (e.g. thanks="Thanks for the feedback!"); it cross-fades in over the SAME cell — replacing
 * the prompt + thumbs in place, not sitting beside them — instantly on an up rating, and after the
 * feedback is submitted on a down rating.
 */
...
const STYLE = `
  :host{ display:inline-grid; align-items:center; height:21px;
