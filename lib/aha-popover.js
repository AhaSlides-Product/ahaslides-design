 ...
 * four `placement`s (top/bottom/left/right), three `trigger`s (click · hover · focus) and a toggleable
 * `arrow`. Content comes from the default slot OR the `content` attribute; `title` renders a bold header.
 *
